...
public class ContactClient {
    ...
    private static String URL = "http://localhost:8080/jersey/rest/contacts";
    
    private static Logger logger = Logger.getLogger(ContactClient.class);
